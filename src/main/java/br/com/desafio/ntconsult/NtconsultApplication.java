...
public class NtconsultApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		hotelRepository.save(Hotel.builder()
				...
				.checkIn("19/11/2024,19/12/2024,20/08/2024,21/05/2024")
				.checkOut("22/02/2024,23/02/2024,25/02/2024,28/02/2024")
				.numberOfRooms(20)
				.numberOfGuest(2)
		...
		hotelRepository.save(Hotel.builder()
				...
				.checkIn("20/11/2024, 19/12/2024, 20/08/2024, 21/05/2024")
				.checkOut("23/02/2024, 23/02/2024, 25/02/2024, 28/02/2024")
				.numberOfRooms(50)
				.numberOfGuest(4)
